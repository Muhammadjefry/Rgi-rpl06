...
<body>
    ...
    <div class="banner-area">
        <h2>Halaman <b><?php echo $_SESSION['username']; ?></b>
        </h2>
    </div>
    <div class="kotak">
        <div class="tulisan">
            <p>TAMBAH SISWA<a href="tambah_view1.html">+</a></p>
        </div>
        <div class="tabel">
            <table border="1">
                <tr>
		...
		?>
                <tr>
                    ...
                    <td>
                        <?php 
				if( $level == "admin"){
				echo '<a href="edit.php?id='. $d['id'].'">Edit</a> | <a href="hapus.php?id='. $d['id'].'">Hapus</a>';
    ...
    <div class="bawah">
        <p>Halo <b><?php echo $_SESSION['username']; ?>,</b> Anda telah login sebagai
            <b><?php echo $_SESSION['level']; ?></b> <a href="logout.php">LOGOUT</a></p>
