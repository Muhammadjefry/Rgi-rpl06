...
class Coaching_Institute_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function coaching_institute_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function coaching_institute_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function coaching_institute_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function coaching_institute_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->coaching_institute_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function coaching_institute_load( $class ) {
