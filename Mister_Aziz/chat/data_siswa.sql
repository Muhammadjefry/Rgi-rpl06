...
--
-- Host: localhost
-- Generation Time: Sep 12, 2023 at 06:13 AM
...
INSERT INTO `siswa` (`nis`, `nama_lengkap`, `nama_panggilan`, `tanggal_lahir`, `jenis_kelamin`, `angkatan`, `jurusan`) VALUES
(1, 'Joko Sanjoyo', 'Jack', '2002-05-17', 0, 2, 0),
(2, 'Alehandro Pedecatre', 'Popo', '2000-12-07', 0, 26, 0),
(3, 'Marko Polo', 'Mark', '2003-12-29', 0, 24, 0),
(4, 'John Alter', 'John', '2000-01-01', 0, 21, 0),
(5, 'Aditya Sanjaya', 'Adit', '2006-07-21', 0, 28, 2),
(6, 'sanjaya putra kusuma', 'kusum', '2006-07-21', 0, 30, 0);
...
INSERT INTO `siswa_2` (`id`, `nama`) VALUES
(1, 'Alehandro'),
(2, 'Mina'),
(3, ''),
(4, ''),
...
(1, 'Anita Sari', '2003-02-08', 1, 1, 29, 1, '', ''),
(2, 'Bonita Ayu Riska', '2004-01-14', 1, 1, 29, 1, '', ''),
(3, 'Farhan', '2000-07-25', 0, 2, 27, 1, '', ''),
(4, 'Putra Cahyo', '2001-06-11', 0, 0, 28, 1, '', ''),
(5, 'Anggra Hardiansyah', '1998-01-20', 0, 0, 25, 1, '', ''),
(6, 'Budi Santoso', '2003-11-11', 0, 0, 28, 1, '', ''),
(7, 'ee', '2005-09-11', 0, 0, 29, 1, '', ''),
(8, 'rgi', '2005-09-11', 0, 0, 29, 1, '', ''),
(9, 'Biboo', '2002-07-24', 1, 1, 27, 1, 'biboo@moai.com', ''),
(10, 'Rani', '2005-09-07', 1, 1, 29, 1, 'rani@gmail.com', 'e32a40fd8e3c06a4ced66baad31e26d5'),
(11, 'Cahyo', '2005-09-07', 0, 0, 29, 1, 'cahyo@gg.gg', 'halodunia'),
(12, 'Suep', '2005-09-01', 0, 0, 29, 1, 'suep@gg.gg', '202cb962ac59075b964b07152d234b70');
