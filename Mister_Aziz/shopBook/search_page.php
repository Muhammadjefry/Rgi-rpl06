...
<body>
    ...
    <div class="heading">
        ...
        <p> <a href="home.php">halaman utama</a> / pencarian </p>
    </div>

    <section class="search-form" id="pencarian">
        <form action="" method="post">
            <input type="text" name="search" placeholder="cari product..." class="box">
    ...
    <section class="products" style="padding-top: 0;">
        ...
        ?>
            ...
            <?php
                        ...
                        echo '<p class="emptyempty">tidak ada hasil yang ditemukan!</p>';
                    }
            }else{
